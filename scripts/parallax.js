...
function parallaxEffect() {
    ...
    greyGround.style.top = value * 1.007 + "px";
    darkGreyTree1.style.top = value * 1.007 + "px";
    darkGreyTree2.style.top = value * 1.007 + "px";
    darkGreyTree3.style.top = value * 1.007 + "px";
    darkGreyTree1.style.left = value * -0.1 + "px";
    darkGreyTree2.style.left = value * -0.08 + "px";
    darkGreyTree3.style.left = value * -0.1 + "px";

    darkGreyTree4.style.top = value * 1.007 + "px";
    darkGreyTree5.style.top = value * 1.007 + "px";
    darkGreyTree6.style.top = value * 1.007 + "px";
    darkGreyTree4.style.left = value * 0.08 + "px";
    darkGreyTree5.style.left = value * 0.1 + "px";
    darkGreyTree6.style.left = value * 0.08 + "px";


    greyTree1.style.top = value * 1.007 + "px";
    greyTree2.style.top = value * 1.007 + "px";
    greyTree3.style.top = value * 1.007 + "px";
    greyTree4.style.top = value * 1.007 + "px";
    greyTree5.style.top = value * 1.007 + "px";
    greyTree6.style.top = value * 1.007 + "px";
    ...
    greyTree7.style.top = value * 1.007 + "px";
    greyTree8.style.top = value * 1.007 + "px";
    greyTree9.style.top = value * 1.007 + "px";
    greyTree7.style.left = value * 0.05 + "px";
    greyTree8.style.left = value * 0.035 + "px";
    greyTree9.style.left = value * 0.05 + "px";

    lightGreyGround.style.top = value * 0.96
     + "px";
    lightGreyTree1.style.top = value * 0.96
     + "px";
    lightGreyTree2.style.top = value * 0.96
     + "px";
    lightGreyTree3.style.top = value * 0.96
     + "px";
    lightGreyTree4.style.top = value * 0.96
     + "px";
    lightGreyTree5.style.top = value * 0.96
     + "px";
    ...
    lightGreyTree6.style.top = value * 0.96
     + "px";
    lightGreyTree7.style.top = value * 0.96
     + "px";
    lightGreyTree8.style.top = value * 0.96
     + "px";
    lightGreyTree9.style.top = value * 0.96
     + "px";
    ...
    lightGreyTree10.style.top = value * 0.96
     + "px";
    lightGreyTree11.style.top = value * 0.96
     + "px";
    lightGreyTree12.style.top = value * 0.96
     + "px";
